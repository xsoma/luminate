#include "classid_parser.h"
#include "../includes.hpp"

inline int parser_classid::GetClassID(const char* classname)
{
	/*ServerClass* serverclass = g_csgo.m_server->GetAllServerClasses();
	int id = 0;
	while (serverclass)
	{
...
void parser_classid::DumpClassIDs()
{
	//Dump all class ids
